...
from src.benchmarks.performance_tester import run_performance_tests, generate_performance_summary
from src.benchmarks.utilities import cleanup_generated_files
from src.benchmarks.config import PATHS


def run_benchmark(fast_mode=False, no_cleanup=False, max_values=None, generate_charts=True):
    """
    ...
    try:
        ...
        generated_files = generate_all_transpiled_files(fast_mode=fast_mode, max_values=max_values)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='TransPYler Benchmark Runner - Modular Architecture')
    ...
    run_benchmark(fast_mode=args.fast, no_cleanup=args.no_cleanup, max_values=args.values, generate_charts=not args.no_charts)