...
ALGORITHM_CONFIGS = {
    ...
    'selection_sort': {
        ...
        'default_range': [10, 50, 100, 200, 300, 500, 750, 1000, 1250, 1500]
    }
}
...
PATHS = {
    ...
    'python_original': Path(__file__).parent / "python_original",
    'cpp_manual': Path("src/benchmarks/cpp_manual"),
...
def get_manual_cpp_file_path(algorithm_name):
    ...
    if config:
        return PATHS['cpp_manual'] / config['manual_cpp_file']
    return None